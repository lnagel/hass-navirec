...
A Home Assistant custom integration for [Navirec](https://www.navirec.com/) fleet management platform. Track your vehicles in real-time with GPS location, sensor data, and vehicle state monitoring.
...
| Door Lock | lock | Central locking state |
...
# Start development container with Home Assistant
./scripts/develop
```
