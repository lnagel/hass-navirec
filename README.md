...
_Integration to integrate with [Navirec][navirec]._
...
`sensor` | Show info from Navirec API.
...
1. In the `custom_components` directory (folder) create a new folder called `navirec`.
1. Download _all_ the files from the `custom_components/navirec/` directory (folder) in this repository.
1. Place the files you downloaded in the new directory (folder) you created.
1. Restart Home Assistant
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "Navirec"
...
[navirec]: https://github.com/lnagel/hass-navirec
